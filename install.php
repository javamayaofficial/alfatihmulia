            ...
            if ($sql === false) {
                ...
                if (!$conn->multi_query($sql)) {
                    ...
                    $seedSettings = [
                        ...
                        'about_pembina_list' => "Ketua Pembina|Riyandi",
                        'about_pengawas_list' => "Ketua Pengawas|Cut Rossy Meutia",
                        'about_pengurus_list' => "Ketua Yayasan|Yudha Eris Setiawan\nSekretaris|Ari Cipta Robbi\nBendahara|Ichsan Nugraha",
