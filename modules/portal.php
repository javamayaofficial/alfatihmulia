...
<?php if ($isRelawan):
    ...
    $target   = (int) setting('umrah_target','10000000');
...
?>
  <div class="dash-grid">
    ...
    <div class="stat-card stat-gold"><span class="stat-ic">🏆</span><b>#<?= $rank ?></b><span>Peringkat Saat Ini</span></div>
  </div>

  <div class="card reward-card">
    <h3>🕋 Progress Target Reward Relawan</h3>
    ...
    <p class="muted">Terus kumpulkan kebaikan secara bertahap. Progress ini dihitung dari donasi terverifikasi yang masuk lewat referral Anda.</p>
  </div>
